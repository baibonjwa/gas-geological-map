...
namespace LibCommonForm
{
    public partial class SelectTunnelSimple : UserControl
    {
        ...
        private void SelectTunnelSimple_Load(object sender, EventArgs e)
        {
            ...
            {
                XmlNodeList nodes = doc.DocumentElement.SelectNodes("/Tunnel/Tunnel");

                //List<TunnelSimple> Tunnel = new List<TunnelSimple>();
                if (nodes != null)
        ...
        private void WriteRecentTunnelXml()
        {
            ...
            for (int i = 1; i < cbxTunnel.Items.Count; i++)
            {
                ...
                if (tunnel != null)
                    writer.WriteElementString("ID", tunnel.id.ToString(CultureInfo.InvariantCulture));   // <-- These are new

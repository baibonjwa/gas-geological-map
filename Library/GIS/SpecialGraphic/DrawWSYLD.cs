...
namespace GIS.SpecialGraphic
{
    ...
    public class DrawWSYLD
    {
        ...
        //标题
        public string m_strBT = "P";//标题
        public string m_strWSYLZ = "2.3MPa";//分子
        public string m_strCDBG = "-600";//分母左侧
        public string m_strMS = "620";//分母右侧
        //画笔
        ...
        /// <param name="strWSYLZ"></params>
        /// <params name="strCDBG"></params>
        /// <params name="strMS"></params>
        public DrawWSYLD(string strBT, string strWSYLZ, string strCDBG, string strMS)
        {
            m_strBT = strBT;
            m_strWSYLZ = strWSYLZ;
            m_strCDBG = strCDBG;
        ...
        private void DrawSymbol()
        {
            ...
            //根据宽度来决定，中间位置为60
            //2.3MPa
            int width_Shang = Convert.ToInt32(g.MeasureString(m_strWSYLZ, m_pFont2).Width / 2);
            m_pBTWZPoint.X = 60 - width_Shang;
            m_pBTWZPoint.Y = 12;

            g.DrawString(m_strWSYLZ, m_pFont2, m_pBrush, m_pBTWZPoint);

...
namespace GIS.GraphicModify
{
    ...
    /// 剪切
    /// </summary>
    [Guid("c249c817-9252-4456-865f-e078d6f75eb2")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("GIS.GraphicModify.EditCutCommand")]
    public sealed class EditCutCommand : BaseCommand
    {
        ...
        public EditCutCommand()
        {
            ...
            base.m_category = "修改"; 
            base.m_caption = "剪切";  
            base.m_message = "剪切选中要素"; 
            base.m_toolTip = "剪切";  
            base.m_name = "EditCutCommand";   

            try
            {
                base.m_bitmap = Resources.EditCut16;
                m_command = new ESRI.ArcGIS.Controls.ControlsEditingCutCommandClass();
        ...
        public override void OnClick()
        {
            try
            {
                ...
                {
                    DataEditCommon.g_pMyMapCtrl.CurrentTool = null;
                    MessageBox.Show("当前图层没有可剪切的元素！");
                    return;
                }
                GIS.Common.DataEditCommon.copypaste = 2;
